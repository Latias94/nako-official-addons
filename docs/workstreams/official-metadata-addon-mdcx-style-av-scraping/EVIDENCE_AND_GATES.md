...
| Targeted bulk tests | `cargo nextest run -p nako-metadata-scraper bulk --no-fail-fast` | Passed | 5 passed. |
...
| Package tests | `cargo nextest run -p nako-metadata-scraper --no-fail-fast` | Passed | 162 passed, 2 skipped. |
